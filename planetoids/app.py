...
class Planetoids(GameApp):
    ...
    # Invariant: _state is one of STATE_INACTIVE, STATE_LOADING, STATE_ACTIVE
    #            STATE_COMPLETE
    #
    ...
    def update(self,dt):
        ...
        STATE_COMPLETE: This state indicates the game has ended. The application
        switches to this state when the wave ends, either when the ship has
        been destroyed or all asteroids have been destroyed.
        ...
        elif not self._wave.getWin() is None:
    ...
    def draw(self):
        ...
        if not self._wave is None:
            self._wave.draw(self.view, self)
